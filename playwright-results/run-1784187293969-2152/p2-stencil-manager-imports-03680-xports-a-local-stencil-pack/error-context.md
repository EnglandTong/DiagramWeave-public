...
Locator:  locator('.node[data-shape="qa_queue"]')
Expected: 1
Received: 0
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('.node[data-shape="qa_queue"]')
      ...
      - generic [ref=e337]:
        ...
        - generic [ref=e369]:
          ...
          - generic [ref=e374]:
            ...
            - generic [ref=e376]: "1"
  - dialog "开始项目" [ref=e378]:
    - button "关闭" [active] [ref=e379] [cursor=pointer]:
      - img [ref=e380]
    - generic [ref=e383]: 开始项目
    - generic [ref=e384]: 请选择保存新档案、打开旧档案，或暂不处理。
    - generic [ref=e385]:
      - button "取消" [ref=e386] [cursor=pointer]: 暂不处理
      - button "打开" [ref=e387] [cursor=pointer]: 打开旧档案
      - button "确认" [ref=e388] [cursor=pointer]: 保存新档案
  - generic [ref=e389]:
    - generic [ref=e390]:
      - generic [ref=e391]: 表格编辑
      - paragraph [ref=e392]: 节点表填步骤 · 连线表填「起点编号→终点编号」 · 画布改完点刷新 · 表格改完点应用
      - button "展开说明" [ref=e393] [cursor=pointer]: 说明
      - generic [ref=e394]:
        - button "从画布同步到表格" [ref=e395] [cursor=pointer]:
          - img [ref=e396]
        - button "将表格内容应用到画布" [ref=e399] [cursor=pointer]:
          - img [ref=e400]
        - button "关闭表格编辑" [ref=e402] [cursor=pointer]:
          - img [ref=e403]
    - generic:
      - generic [ref=e406]:
        - generic [ref=e407]:
          - button "编辑各步骤节点" [ref=e408] [cursor=pointer]: 节点表
          - button "编辑节点之间的连线" [ref=e409] [cursor=pointer]: 连线表
        - generic [ref=e410]:
          - button "在表格末尾添加一行空节点" [ref=e411] [cursor=pointer]: + 节点
          - button "先点击行选中（高亮），再删除" [ref=e412] [cursor=pointer]: 删节点
      - generic "流程数据表":
        - table [ref=e413]:
          - rowgroup [ref=e414]:
            - row "编号 简介 去向 角色 图形 详细说明 耗时天 泳道 图层 目标页" [ref=e415] [cursor=pointer]:
              - columnheader "编号" [ref=e416]
              - columnheader "简介" [ref=e417]
              - columnheader "去向" [ref=e418]
              - columnheader "角色" [ref=e419]
              - columnheader "图形" [ref=e420]
              - columnheader "详细说明" [ref=e421]
              - columnheader "耗时天" [ref=e422]
              - columnheader "泳道" [ref=e423]
              - columnheader "图层" [ref=e424]
              - columnheader "目标页" [ref=e425]
          - rowgroup
    - generic [ref=e426]:
      - strong [ref=e427]: 怎么用：
...
> 24 |   await expect(page.locator('.node[data-shape="qa_queue"]')).toHaveCount(1);
     |                                                              ^ Error: expect(locator).toHaveCount(expected) failed
  25 | 
