...
- Name: p2-external-importers.spec.js >> bpmn-moddle preserves DI coordinates and reports unsupported controlled-subset elements
- Location: tests\e2e\p2-external-importers.spec.js:21:1
