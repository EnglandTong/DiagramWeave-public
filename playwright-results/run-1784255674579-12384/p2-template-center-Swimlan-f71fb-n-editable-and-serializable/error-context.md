...
- Name: p2-template-center.spec.js >> Swimlane nodes and lane metadata remain editable and serializable
- Location: tests\e2e\p2-template-center.spec.js:52:1
...
Call log:
  - waiting for locator('.template-btn')
    - locator resolved to <button class="template-btn" aria-label="Templates" onclick="showTemplateDialog()">…</button>
