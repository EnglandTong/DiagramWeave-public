...
```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://127.0.0.1:4173/flowchart-editor.html?highlightNode=e2e-highlight-node
Call log:
  - navigating to "http://127.0.0.1:4173/flowchart-editor.html?highlightNode=e2e-highlight-node", waiting until "load"
