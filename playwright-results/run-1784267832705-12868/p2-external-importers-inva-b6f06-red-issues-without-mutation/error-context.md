...
- Name: p2-external-importers.spec.js >> invalid and unsupported external diagrams return structured issues without mutation
- Location: tests\e2e\p2-external-importers.spec.js:33:1
