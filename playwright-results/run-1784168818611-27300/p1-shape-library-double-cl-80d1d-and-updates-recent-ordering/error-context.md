...
- Name: p1-shape-library.spec.js >> double click inserts at visible canvas center and updates recent ordering
- Location: tests\e2e\p1-shape-library.spec.js:36:1
...
Locator: locator('#shapeRecent .shape-quick-item').first()
...
Call log:
  ...
  - waiting for locator('#shapeRecent .shape-quick-item').first()
    14 × locator resolved to <button type="button" class="shape-quick-item">Decision</button>
